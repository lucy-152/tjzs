...
<script type="text/javascript">
	...
	var CHKLOGOINNAME="^(?![0-9]+$)(?![a-zA-Z]+$)[a-zA-Z0-9]{6,16}$";	
	...
	function chkLoginname() {
		...
		if(reg.test(loginname)){//正确
			...
			spanEle.innerHTML="用户名必须包含数字与字母且不能低于六位";
	...
	function chkPassword() {
		...
		if(reg.test(password)){//正确
			...
			spanEle.innerHTML="密码必须包含数字与字母且不能低于六位";
			spanEle.style.color="red";
			//清空文本
			//pwdEle.value="";
			//重新聚焦
...
<div class="box-positon">
	...
	<form class="ropt">
		<input type="submit" onclick="javascript:history.back()" value="返回列表" class="return-button"/>
	</form>
	<div class="clear"></div>
</div>
			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="password" id="password" maxlength="100" onblur="chkPassword()"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="repwd" id="repwd" maxlength="100" onblur="chkRePwd()"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="email" maxlength="80" onblur="chkExistEmail(email)"/>
